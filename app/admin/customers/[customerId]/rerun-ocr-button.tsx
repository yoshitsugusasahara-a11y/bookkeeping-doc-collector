...
import { rerunSubmissionOcrAsAdmin } from "./actions";
...
export function RerunOcrButton({
  ...
  async function handleClick() {
    ...
    try {
      const result = await rerunSubmissionOcrAsAdmin(customerId, submissionId);
      ...
      console.error("Failed to rerun OCR as admin", rerunError);
